...
@objc(LottieSplashScreen) class LottieSplashScreen: CDVPlugin {
    ...
    private func createAnimationViewContainer() {
        ...
        let backgroundColor = "#000000"//getUIModeDependentPreference(basePreferenceName: "LottieBackgroundColor", defaultValue: "#000000")
    ...
    let animationWidth = fullScreenSize.width
    let animationHeight = fullScreenSize.height
    ...
    autoresizingMask.insert(isPortrait ? .flexibleWidth : .flexibleHeight)
